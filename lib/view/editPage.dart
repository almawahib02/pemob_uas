...
@override
  void initState() {
    ...
    _docid.value = TextEditingValue(text: widget.user!.uid.toString());
    _user_name.value = TextEditingValue(text: widget.user!.name.toString());
    _password.value = TextEditingValue(text: widget.user!.password.toString());
    _billing.value = TextEditingValue(text: widget.user!.billing.toString());
  ...
  Widget build(BuildContext context) {
    ...
    final passwordField = TextFormField(
        ...
        decoration: InputDecoration(
            ...
            border:
                OutlineInputBorder(borderRadius: BorderRadius.circular(32.0))));
    final billingField = TextFormField(
        controller: _billing,
        autofocus: false,
        validator: (value) {
          if (value == null || value.trim().isEmpty) {
